...
const MESSAGE = `LAST CALL: DentalCall AI founders offer

Your practice was selected:
• $199/mo (60% off forever)
...
OR call 650-201-5786 to start now

Only accepting 2 more practices at this rate
...
const leads = lines.map(line => {
    ...
    if (!l.phone || !l.phone.startsWith('+') || l.brs < 65) return false;
